...
public class FirstMapperAlternative extends Mapper<LongWritable, QuadWritable, Text, NullWritable> {

    private static final Logger log = LoggerFactory.getLogger(FirstMapperAlternative.class);
