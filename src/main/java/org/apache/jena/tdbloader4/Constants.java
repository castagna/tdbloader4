...
public class Constants {
    ...
    private static final String NAME_PREFIX = "tdbloader4-";
	public static final String NAME_STATS = NAME_PREFIX + "stats";
	public static final String NAME_INFER = NAME_PREFIX + "inference";
	public static final String NAME_FIRST = NAME_PREFIX + "first";
	public static final String NAME_SECOND = NAME_PREFIX + "second";
	public static final String NAME_THIRD = NAME_PREFIX + "third";
	public static final String NAME_FOURTH = NAME_PREFIX + "fourth";
	...
	public static final String TDBLOADER4_COUNTER_GROUPNAME = "TDBLoader4 Counters";
	public static final String TDBLOADER4_COUNTER_MALFORMED = "Malformed";
	public static final String TDBLOADER4_COUNTER_QUADS = "Quads (including duplicates)";
	public static final String TDBLOADER4_COUNTER_TRIPLES = "Triples (including duplicates)";
	public static final String TDBLOADER4_COUNTER_DUPLICATES = "Duplicates (quads or triples)";
	public static final String TDBLOADER4_COUNTER_RDFNODES = "RDF nodes";
	public static final String TDBLOADER4_COUNTER_RECORDS = "Index records";
