...
import org.apache.jena.tdbloader4.InferDriver;
...
public class TestInferLocal {
    ...
    @Test public void test() throws Exception {
        ...
        // assert isomorphism
        assertTrue( tdbloader4.dump(dsgRIOT, dsgMR), tdbloader4.isomorphic(dsgRIOT, dsgMR));
        assertTrue( tdbloader4.dump(dsgExpected, dsgMR), tdbloader4.isomorphic(dsgExpected, dsgMR));
    }
